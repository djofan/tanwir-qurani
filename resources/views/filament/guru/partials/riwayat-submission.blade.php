...
<div style="display:flex;flex-direction:column;gap:16px;max-height:65vh;overflow-y:auto;">
    ...
    <div>
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
            @forelse($logs as $log)
                <div style="padding:12px 14px;border-radius:10px;border:1px solid {{ $log->status_at_time === 'approved' ? 'rgba(34,197,94,0.3)' : 'rgba(239,68,68,0.3)' }};">
                    <div style="display:flex;justify-content:space-between;">
                        <span style="font-size:13px;font-weight:600;color:{{ $log->status_at_time === 'approved' ? '#16a34a' : '#dc2626' }};">
